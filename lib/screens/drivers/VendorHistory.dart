...
class VendorHistory extends StatefulWidget {
  @override
  _VendorHistoryState createState() => _VendorHistoryState();
}
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [Container(
                      ...
                      Expanded(child: Center(child: Text("Vendor Detail",style: GoogleFonts.poppins(fontSize: 25,fontWeight: FontWeight.bold,color:Theme.of(context).accentColor),)))
