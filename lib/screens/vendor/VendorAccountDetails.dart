...
class VendorAccountDetails extends StatefulWidget {
  @override
  _VendorAccountDetailsState createState() => _VendorAccountDetailsState();
}

class _VendorAccountDetailsState extends State<VendorAccountDetails> {
