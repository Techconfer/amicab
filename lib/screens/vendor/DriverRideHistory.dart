import 'package:aim_cab/screens/user/model/RideHistory.dart';
                                        ...
                                        child:Container(
                                          ...
                                          child:Column(
                                            ...
                                            children: [
                                              ...
                                              Text(DateFormat("d MMMM yyyy, hh:mm ").format(DateTime.parse(snapshot.data[index].rideDetail.tripDate.toString())),style:GoogleFonts.poppins(color: Colors.black54,fontSize: 15)),
                                              Divider(),
                                              Container(
                                                ...
                                                Container(
                                                    width: 200,
                                                    child: Text(snapshot.data[index].rideDetail.source.toString(),style:GoogleFonts.poppins(color: Colors.black54,fontSize: 15)))
                                                  ],),
                                              ),
                                              Container(
                                              ...
                                              Container(
                                                ...
                                                child: Row(children: [Text("11:24",style:GoogleFonts.poppins(color: Colors.black12,fontSize: 15)),
                                                  ...
                                                  Container(
                                                      width: 200,
                                                      child: Text(snapshot.data[index].rideDetail.destination.toString(),style:GoogleFonts.poppins(color: Colors.black54,fontSize: 15)))
                                                ],),
                                              )
                                            ],
                                          )
...
print("user_id_ride:"+user.sId);
    var   response = await dio.get('/view-driver-bookings/${user.sId}?offset=0',
      options: Options(
        headers: {
