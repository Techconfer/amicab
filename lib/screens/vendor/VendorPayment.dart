...
import 'package:aim_cab/screens/user/screens/UserAccount.dart';
...
import 'VendorAccountDetails.dart';
              ...
              children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            child:Chip(
                              label: Text("${Varibles.TRANSPORTER_WALLET_BALLANCE}",style: GoogleFonts.poppins(color: Theme.of(context).accentColor,fontWeight: FontWeight.bold),),
                            ))
                      ],),
                  ),
                ),
                ...
                InkWell(
                  onTap: (){
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) =>VendorAccountDetails()),
                    );
                  },
                  child: Container(
                    padding: EdgeInsets.symmetric(horizontal: 20,vertical: 10),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("${Varibles.TRANSPORTER_WALLET_BALLANCE} INR",style: GoogleFonts.poppins(fontSize: 16,fontWeight: FontWeight.bold,color:Theme.of(context).primaryColor),),
                    ],
                  ),
                ...
                Container(
                  ...
                  child: NeumorphicButton(
                      ...
                      child: Container(
                          ...
                          width: 200,
                          child: Center(child: Text("SEND REQUEST",style: GoogleFonts.poppins(color: HexColor("#8B9EB0"),fontSize: 18,fontWeight: FontWeight.bold),))),
                      onPressed: (){
